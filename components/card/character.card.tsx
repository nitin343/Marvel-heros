                ...
                <div className="container px-5 py-16 md:py-5 md:px-0  mx-auto flex md:flex-col overflow-x-auto  flex-row flex-wrap gap-3 justify-center align-baseline w-full">
                    {
                       character && character.map((data: any) => (
                            <div onMouseEnter={() => setVisiblity(data, 'visible')} onMouseLeave={() => setVisiblity(data, 'invisible')} key={data.id} onClick={() => heroCard(data)} className="flex relative flex-wrap -m-4 md:m-0 mb-10 text-center w-1/3 S:w-[100%] md:w-[100%] md:my-[10px] justify-center align-baseline cursor-pointer">
                                <div>
